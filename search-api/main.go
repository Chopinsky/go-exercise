...
func createDocumentsEndpoint(c *gin.Context) {
	...
	bulk := elasticClient.Bulk().Index(elasticIndexName).Type(elastticTypeName)
...
func searchEndpoint(c *gin.Context) {
	...
	if err != nil {
		log.Println(err)
		errorResponse(c, http.StatusInternalServerError, "Unable to process the query")
		return
	}
